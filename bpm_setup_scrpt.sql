...
INSERT INTO business_process(name,created_by)
VALUES('First Registration of Title',100);

INSERT INTO business_process(name,created_by)
VALUES('Transfer of Registered Title',100);

INSERT INTO business_process(name,created_by)
VALUES('Create and Register new Interest',100);
-----------
INSERT INTO activity(name,short_desc,created_by,activity_mgr)
VALUES('Prepare application','Prepare new application for submission',100,109);

INSERT INTO activity(name,short_desc,created_by,activity_mgr)
VALUES('Lodge Application','Receiving new application into the system for process',100,112);

INSERT INTO activity(name,short_desc,created_by,activity_mgr)
VALUES('Scan supporting documents','Scan all supporting documents of an application into the system',100,114);

INSERT INTO activity(name,short_desc,created_by,activity_mgr)
VALUES('Extract root of title','Extract root of title FROM supporting documents',100,113);

INSERT INTO activity(name,short_desc,created_by,activity_mgr)
VALUES('Verify and approve/reject application(Initial)','Conduct internal verification of root of title and approve or reject the application',100,115);

INSERT INTO activity(name,short_desc,created_by,activity_mgr)
VALUES('Give public notice','Notice public of intended action on the application',100,111);

INSERT INTO activity(name,short_desc,created_by)
VALUES('Approve/Reject(Final)','Final approval and issuance of certificate of completion',100);
...
insert into process_activities(process_id,activity_id,priority,dependent_list)
values(100,1,2,number_ttyp('0'));

insert into process_activities(process_id,activity_id,priority,dependent_list)
values(100,2,2,number_ttyp('0'));

insert into process_activities(process_id,activity_id,priority,dependent_list)
values(100,3,4,number_ttyp(1,2));
-----
insert into process_activities(process_id,activity_id,priority,dependent_list)
values(100,4,5,number_ttyp(3));

insert into process_activities(process_id,activity_id,priority,dependent_list)
values(100,5,6,number_ttyp(4));



begin case_mgt_pkg.create_business_case(100,115); end;
--
--update workflow set status = 'COMPLETED', assigned_to = 113, assigned_on = sysdate - interval '40' minute 
--WHERE case_number = 1 and activity_id = 0;
--
--update workflow set status = 'COMPLETED', assigned_to = 115, assigned_on = sysdate - interval '20' minute 
--WHERE case_number = 1 and activity_id = 1;
--
--update workflow set status = 'COMPLETED', assigned_to = 114, assigned_on = sysdate - interval '5' minute 
--WHERE case_number = 1 and activity_id = 2;
--
--update workflow set status = 'IN PROGRESS', assigned_to = 114, assigned_on = sysdate - interval '5' minute 
--WHERE case_number = 1 and activity_id = 3;
